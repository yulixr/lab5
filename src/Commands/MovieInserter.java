...
public class MovieInserter {
        ...
        try {
            ...
            if (x.equals("") || x.equals(null)) this.setCoordinateX(coords);
                ...
                if (xn > -296) {
                    ...
                    System.out.println("Минимум -297");
    ...
    */
    ...
    {
        System.out.println("Введите дату рождения в формате yyyy-MM-dd HH:mm , 0 если пусто:");
        System.out.print("- ");
        String rat = scanner.nextLine();
        try {
            DateTimeFormatter formatter = DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm");
            LocalDateTime formatDateTime;
            if (rat.equals("0") || rat.equals("")) {
    ...
    public void setDirectorEyeColor(Person director) {
        System.out.println("Введите цвет глаз, регистр не важен (BLUE, YELLOW, ORANGE, BROWN), 0 если пусто:");
        System.out.print("- ");
        String rat = scanner.nextLine().toUpperCase();
        try {
            if (rat.equals("0")) {
    ...
    {
        System.out.println("Введите цвет глаз, регистр не важен (GREEN, BLACK, BLUE, YELLOW, WHITE):");
        System.out.print("- ");
        String rat = scanner.nextLine().toUpperCase();
        try {
